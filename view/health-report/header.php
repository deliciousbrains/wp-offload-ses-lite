...
<table width="100%" bgcolor="#34203a" style="background-color: #34203a; color: #ffffff">
	<tr>
		<td style="padding: 20px 0 20px 20px;">
			<h3 style="font-size: 24px; font-weight: normal; margin: 0; color: #ffffff;"><?php esc_html_e( 'Email Sending Health', 'wp-offload-ses' ); ?></h3>
			<p style="margin: 4px 0 0 0;"><?php echo esc_html( $this->get_health_report()->get_report_date_range() ); ?></p>
		</td>
