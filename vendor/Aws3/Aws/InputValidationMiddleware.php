...
class InputValidationMiddleware
{
     ...
     * @return callable     */
    public static function wrap(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Service $service, $mandatoryAttributeList)
    {
    ...
    public function __construct(callable $nextHandler, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Service $service, $mandatoryAttributeList)
    {
        $this->service = $service;
        $this->nextHandler = $nextHandler;
        $this->mandatoryAttributeList = $mandatoryAttributeList;
    }
    public function __invoke(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\CommandInterface $cmd)
    {
