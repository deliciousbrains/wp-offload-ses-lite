...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointDiscovery\Exception\ConfigurationException;
...
class ConfigurationProvider extends \DeliciousBrains\WP_Offload_SES\Aws3\Aws\AbstractConfigurationProvider implements \DeliciousBrains\WP_Offload_SES\Aws3\Aws\ConfigurationProviderInterface
{
    ...
    protected static $interfaceClass = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointDiscovery\ConfigurationInterface::class;
    protected static $exceptionClass = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointDiscovery\Exception\ConfigurationException::class;
    /**
    ...
    public static function env($cacheLimit = self::DEFAULT_CACHE_LIMIT)
    {
        return function () use($cacheLimit) {
            ...
            if ($enabled !== false && $enabled !== '') {
                return \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\promise_for(new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointDiscovery\Configuration($enabled, $cacheLimit));
            }
    ...
    public static function fallback($config = [])
    {
        ...
        return function () use($enabled) {
            return \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\promise_for(new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointDiscovery\Configuration($enabled, self::DEFAULT_CACHE_LIMIT));
        };
    }
    /**
    ...
    public static function ini($profile = null, $filename = null, $cacheLimit = self::DEFAULT_CACHE_LIMIT)
    {
        ...
        return function () use($profile, $filename, $cacheLimit) {
            ...
            return \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\promise_for(new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointDiscovery\Configuration($data[$profile]['endpoint_discovery_enabled'], $cacheLimit));
        };
    }
    /**
    ...
    public static function unwrap($config)
    {
        ...
        if ($config instanceof ConfigurationInterface) {
            ...
            if (isset($config['cache_limit'])) {
                return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointDiscovery\Configuration($config['enabled'], $config['cache_limit']);
            }
            return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointDiscovery\Configuration($config['enabled'], self::DEFAULT_CACHE_LIMIT);
        }
