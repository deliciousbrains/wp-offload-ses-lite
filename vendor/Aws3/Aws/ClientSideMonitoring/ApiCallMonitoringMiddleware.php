 ...
 * @internal
 */
class ApiCallMonitoringMiddleware extends \DeliciousBrains\WP_Offload_SES\Aws3\Aws\ClientSideMonitoring\AbstractMonitoringMiddleware
{
    /**
    ...
    private static function getResultAttemptCount(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\ResultInterface $result)
    {
