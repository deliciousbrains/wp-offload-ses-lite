 ...
 * @internal
 */
class ApiCallAttemptMonitoringMiddleware extends \DeliciousBrains\WP_Offload_SES\Aws3\Aws\ClientSideMonitoring\AbstractMonitoringMiddleware
{
    /**
     ...
     * {@inheritdoc}
     */
    public static function getRequestData(\DeliciousBrains\WP_Offload_SES\Aws3\Psr\Http\Message\RequestInterface $request)
    {
    ...
    private static function getResultAttemptLatency(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\ResultInterface $result)
    {
    ...
    private static function getResultDestinationIp(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\ResultInterface $result)
    {
        if (isset($result['@metadata']['transferStats']['http'])) {
            $attempt = end($result['@metadata']['transferStats']['http']);
    ...
    private static function getResultDnsLatency(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\ResultInterface $result)
    {
        if (isset($result['@metadata']['transferStats']['http'])) {
            $attempt = end($result['@metadata']['transferStats']['http']);
    ...
    private static function getResultHttpStatusCode(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\ResultInterface $result)
    {
        return $result['@metadata']['statusCode'];
    }
    private static function getAwsExceptionAttemptLatency(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Exception\AwsException $e)
    {
    ...
    private static function getAwsExceptionErrorCode(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Exception\AwsException $e)
    {
        return $e->getAwsErrorCode();
    }
    private static function getAwsExceptionMessage(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Exception\AwsException $e)
    {
        return $e->getAwsErrorMessage();
    }
    private static function getAwsExceptionDestinationIp(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Exception\AwsException $e)
    {
        $attempt = $e->getTransferInfo();
        if (isset($attempt['primary_ip'])) {
            return $attempt['primary_ip'];
    ...
    private static function getAwsExceptionDnsLatency(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Exception\AwsException $e)
    {
        $attempt = $e->getTransferInfo();
        if (isset($attempt['namelookup_time'])) {
            return (int) floor($attempt['namelookup_time'] * 1000);
    ...
    private static function getAwsExceptionHttpStatusCode(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Exception\AwsException $e)
    {
