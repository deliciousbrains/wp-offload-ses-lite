...
namespace DeliciousBrains\WP_Offload_SES\Aws3\Aws\Retry;
...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Retry\Exception\ConfigurationException;
...
class ConfigurationProvider extends \DeliciousBrains\WP_Offload_SES\Aws3\Aws\AbstractConfigurationProvider implements \DeliciousBrains\WP_Offload_SES\Aws3\Aws\ConfigurationProviderInterface
{
    ...
    protected static $interfaceClass = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Retry\ConfigurationInterface::class;
    protected static $exceptionClass = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Retry\Exception\ConfigurationException::class;
    /**
    ...
    public static function env()
    {
        return function () {
            ...
            if (!empty($mode)) {
                return \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\promise_for(new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Retry\Configuration($mode, $maxAttempts));
            }
    ...
    {
        return function () {
            return \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\promise_for(new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Retry\Configuration(self::DEFAULT_MODE, self::DEFAULT_MAX_ATTEMPTS));
        };
    }
    /**
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            return \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\promise_for(new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Retry\Configuration($data[$profile][self::INI_MODE], $maxAttempts));
        };
    }
    /**
    ...
    public static function unwrap($config)
    {
        ...
        if (is_int($config)) {
            return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Retry\Configuration('legacy', $config + 1);
        }
        if (is_array($config) && isset($config['mode'])) {
            $maxAttempts = isset($config['max_attempts']) ? $config['max_attempts'] : self::DEFAULT_MAX_ATTEMPTS;
            return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Retry\Configuration($config['mode'], $maxAttempts);
        }
