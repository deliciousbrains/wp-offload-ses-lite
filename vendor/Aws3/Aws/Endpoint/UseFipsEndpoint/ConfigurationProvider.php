...
namespace DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\UseFipsEndpoint;
...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\UseFipsEndpoint\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            $data = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\parse_ini_file($filename, \true, \INI_SCANNER_NORMAL);
            if ($data === \false) {
