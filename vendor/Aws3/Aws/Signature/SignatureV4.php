...
use DeliciousBrains\WP_Offload_SES\Aws3\AWS\CRT\Auth\Signable;
use DeliciousBrains\WP_Offload_SES\Aws3\AWS\CRT\Auth\SignatureType;
use DeliciousBrains\WP_Offload_SES\Aws3\AWS\CRT\Auth\SignedBodyHeaderType;
use DeliciousBrains\WP_Offload_SES\Aws3\AWS\CRT\Auth\Signing;
use DeliciousBrains\WP_Offload_SES\Aws3\AWS\CRT\Auth\SigningAlgorithm;
use DeliciousBrains\WP_Offload_SES\Aws3\AWS\CRT\Auth\SigningConfigAWS;
use DeliciousBrains\WP_Offload_SES\Aws3\AWS\CRT\Auth\StaticCredentialsProvider;
use DeliciousBrains\WP_Offload_SES\Aws3\AWS\CRT\HTTP\Request;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Exception\CommonRuntimeException;
