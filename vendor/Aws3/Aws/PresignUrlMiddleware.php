...
class PresignUrlMiddleware
{
    ...
    private function createPresignedUrl(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\AwsClientInterface $client, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\CommandInterface $cmd)
    {
        ...
        return (string) $signer->presign(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Signature\SignatureV4::convertPostToGet($request, $paramsToAdd ?: ""), $client->getCredentials()->wait(), '+1 hour')->getUri();
    }
}
