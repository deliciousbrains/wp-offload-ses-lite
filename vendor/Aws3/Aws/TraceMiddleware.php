...
class TraceMiddleware
{
     ...
     *   "scrub_auth" is set to true.
     */
    public function __construct(array $config = [], \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Service $service = null)
    {
     ...
     * @return array
     */
    private function getRedactedArray(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\CommandInterface $cmd)
    {
