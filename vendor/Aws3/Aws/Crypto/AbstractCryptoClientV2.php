...
abstract class AbstractCryptoClientV2
{
    ...
    public static $supportedKeyWraps = [\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\KmsMaterialsProviderV2::WRAP_ALGORITHM_NAME];
     ...
     * @internal
     */
    public abstract function encrypt(\DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Psr7\Stream $plaintext, array $options, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MaterialsProviderV2 $provider, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MaterialsProviderInterfaceV2 $provider, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MetadataEnvelope $envelope, array $options = []);
}
