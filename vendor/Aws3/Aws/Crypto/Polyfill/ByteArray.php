...
class ByteArray extends \SplFixedArray
{
    ...
    {
        return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\Polyfill\ByteArray(\pack('N', $num));
    }
    /**
     * @param ByteArray $other
     * @return bool
     */
    public function equals(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\Polyfill\ByteArray $other)
    {
     ...
     * @return ByteArray
     */
    public function exclusiveOr(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\Polyfill\ByteArray $array)
    {
     ...
     * @return ByteArray
     */
    public static function select($select, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\Polyfill\ByteArray $left, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\Polyfill\ByteArray $right)
    {
     ...
     * @return self
     */
    public function set(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\Polyfill\ByteArray $input, $offset = 0, $length = null)
    {
    ...
    {
        return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\Polyfill\ByteArray(\array_slice($this->toArray(), $start, $length));
    }
    /**
