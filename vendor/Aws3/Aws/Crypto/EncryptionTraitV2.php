...
trait EncryptionTraitV2
{
    ...
    private static $encryptClasses = ['gcm' => \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\AesGcmEncryptingStream::class];
    /**
     ...
     * @internal
     */
    public function encrypt(\DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Psr7\Stream $plaintext, array $options, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MaterialsProviderV2 $provider, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MetadataEnvelope $envelope)
    {
        ...
        if (!\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MaterialsProviderV2::isSupportedKeySize($cipherOptions['KeySize'])) {
        ...
        $envelope[\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MetadataEnvelope::CONTENT_KEY_V2_HEADER] = $keys['Ciphertext'];
        unset($keys);
