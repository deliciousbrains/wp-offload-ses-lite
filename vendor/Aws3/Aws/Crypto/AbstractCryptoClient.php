...
abstract class AbstractCryptoClient
{
    ...
    public static $supportedKeyWraps = [\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\KmsMaterialsProvider::WRAP_ALGORITHM_NAME];
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MaterialsProviderInterface $provider, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MetadataEnvelope $envelope, array $cipherOptions = []);
}
