...
namespace DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointV2\Ruleset;
...
class RulesetStandardLibrary
{
    ...
    public function callFunction($funcCondition, &$inputParameters)
    {
        ...
        $result = \call_user_func_array(['DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\EndpointV2\\Ruleset\\RulesetStandardLibrary', $funcName], $funcArgs);
