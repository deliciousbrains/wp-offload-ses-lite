...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Auth\AuthResolver;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Auth\AuthSchemeResolver;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Auth\AuthSchemeResolverInterface;
...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Configuration\ConfigurationResolver;
...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\DefaultsMode\ConfigurationInterface as ConfigModeInterface;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\DefaultsMode\ConfigurationProvider as ConfigModeProvider;
...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\UseDualstackEndpoint\Configuration as UseDualStackEndpointConfiguration;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\UseDualstackEndpoint\ConfigurationInterface as UseDualStackEndpointConfigurationInterface;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider as UseDualStackConfigProvider;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\UseFipsEndpoint\Configuration as UseFipsEndpointConfiguration;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\UseFipsEndpoint\ConfigurationInterface as UseFipsEndpointConfigurationInterface;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\UseFipsEndpoint\ConfigurationProvider as UseFipsConfigProvider;
...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointV2\EndpointDefinitionProvider;
...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Token\Token;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Token\TokenInterface;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Token\BedrockTokenProvider;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Token\TokenProvider;
...
class ClientResolver
{
    ...
    {
        if ($value === \false) {
            $value = new Configuration(\false, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_HOST, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_PORT, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_CLIENT_ID);
            $args['csm'] = $value;
        }
    ...
    public static function _apply_endpoint_provider($value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            if ($value instanceof \DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointV2\EndpointProviderV2) {
            ...
            $args['region'] = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\strip_fips_pseudo_regions($args['region']);
    ...
    public static function _default_endpoint_provider(array $args)
    {
        ...
        if (self::isValidService($serviceName) && self::isValidApiVersion($serviceName, $apiVersion)) {
            ...
            return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointV2\EndpointProviderV2($ruleset, EndpointDefinitionProvider::getPartitions());
        }
        $options = self::getEndpointProviderOptions($args);
    ...
    public static function _apply_suppress_php_deprecation_warning($value, &$args)
    {
        if ($value) {
            ...
            $args['suppress_php_deprecation_warning'] = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\boolean_value(getenv("AWS_SUPPRESS_PHP_DEPRECATION_WARNING"));
        } elseif (!empty($_SERVER["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"])) {
            $args['suppress_php_deprecation_warning'] = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\boolean_value($_SERVER["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"]);
        } elseif (!empty($_ENV["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"])) {
            $args['suppress_php_deprecation_warning'] = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\boolean_value($_ENV["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"]);
        }
    ...
    public static function _default_endpoint(array &$args)
    {
        ...
        $serviceIdentifier = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\manifest($args['service'])['serviceIdentifier'];
...
EOT;
    ...
    private static function isValidService($service)
    {
        ...
        $services = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\manifest();
