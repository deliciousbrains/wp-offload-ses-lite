...
class ClientResolver
{
    ...
    public static function _apply_credentials($value, array &$args)
    {
        ...
        if ($value instanceof CredentialsInterface) {
            ...
            throw new IAE('Credentials must be an instance of ' . 'DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\Credentials\\CredentialsInterface, an associative ' . 'array that contains "key", "secret", and an optional "token" ' . 'key-value pairs, a credentials provider function, or false.');
        }
    }
    ...
    public static function _apply_token($value, array &$args)
    {
        ...
        if ($value instanceof Token) {
            ...
            throw new IAE('Token must be an instance of ' . 'DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\Token\\TokenInterface, an associative ' . 'array that contains "token" and an optional "expires" ' . 'key-value pairs, a token provider function, or false.');
        }
    }
