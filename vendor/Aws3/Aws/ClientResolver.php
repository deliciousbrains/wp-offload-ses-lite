...
class ClientResolver
{
    ...
    public static function _apply_user_agent($inputUserAgent, array &$args, HandlerList $list)
    {
        ...
        if (\defined('DeliciousBrains\\WP_Offload_SES\\Aws3\\HHVM_VERSION')) {
        ...
        if (isset($args['endpoint_discovery'])) {
            if ($args['endpoint_discovery'] instanceof \DeliciousBrains\WP_Offload_SES\Aws3\Aws\EndpointDiscovery\Configuration && $args['endpoint_discovery']->isEnabled()) {
        ...
        if (isset($args['retries'])) {
            if ($args['retries'] instanceof \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Retry\Configuration) {
