...
use DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\BodySummarizer;
use DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\BodySummarizerInterface;
use DeliciousBrains\WP_Offload_SES\Aws3\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null) : self
    {
        ...
        $uri = \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
