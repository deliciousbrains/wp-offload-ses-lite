...
use DeliciousBrains\WP_Offload_SES\PHPStan\Reflection\ParametersAcceptor;
use DeliciousBrains\WP_Offload_SES\PHPStan\TrinaryLogic;
use DeliciousBrains\WP_Offload_SES\PHPStan\Type\Type;
...
class MacroMethodReflection implements MethodReflection
{
    ...
    public function getPrototype() : \DeliciousBrains\WP_Offload_SES\PHPStan\Reflection\ClassMemberReflection
    {
        return $this;
    }
